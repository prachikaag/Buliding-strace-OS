...
int keys[NUM_KEYS];
// declaring the locks
// here we have a separate lock for each of the bucket
...
void insert(int key, int val) {
    ...
    // aquire the lock on the bucket current key will be inserted in
...
int main(int argc, char **argv) {
    ...
    // initializing the locks for each of the buckets
